...
exports.edit = function (req, res) {
  ...
  post
    .update()
    .then((status) => {
      //the post was susscessfully updated in the database
      //or user did have permission but there was validation error
      if (status == "success") {
        //post was upadted in db
    ...
    .catch(() => {
      //a post with the reequested id doesn' exist
