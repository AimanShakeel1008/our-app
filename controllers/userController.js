...
exports.sharedProfileData = async function (req, res, next) {
  ...
  //retreive posts,followers and following count
...
exports.home = async function (req, res) {
  if (req.session.user) {
    //ftech feed of posts fro current user
...
exports.profilePostsScreen = function (req, res) {
  //ask our post for posts by a certain author id
...
exports.apiMustBeLoggedIn = function (req, res, next) {
  try {
    ...
    res.json("You must provide a valid session.");
  }
};
