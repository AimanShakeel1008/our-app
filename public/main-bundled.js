    ...
    e.exports = (function () {
      ...
      return (function e() {
        ...
        var i = t.document,
          ...
          w = t.HTMLTemplateElement,
          S = t.Node,
          X = t.NodeFilter,
          K = t.NamedNodeMap,
          $ = void 0 === K ? t.NamedNodeMap || t.MozNamedAttrMap : K,
          J = t.Text,
          Y = t.Comment,
          Q = t.DOMParser,
          Z = t.trustedTypes;
        ...
        var te = V(Z, i),
          re = te && Ce ? te.createHTML("") : "",
          ne = s,
          oe = ne.implementation,
          ...
          ue = {};
        r.isSupported =
          oe && void 0 !== oe.createHTMLDocument && 9 !== s.documentMode;
        var le = H,
          fe = F,
          de = U,
          pe = I,
          ...
          ye = P,
          ve = null,
          ge = E({}, [].concat(W(k), W(R), W(O), W(N), W(M))),
          be = null,
          Te = E({}, [].concat(W(D), W(_), W(C), W(j))),
          Ae = null,
          xe = null,
          we = !0,
          Se = !0,
          ...
          Ve = function (e) {
            (We && We === e) ||
              ((e && "object" === (void 0 === e ? "undefined" : B(e))) ||
                (e = {}),
              (ve = "ALLOWED_TAGS" in e ? E({}, e.ALLOWED_TAGS) : ge),
              (be = "ALLOWED_ATTR" in e ? E({}, e.ALLOWED_ATTR) : Te),
              (ze =
                "ADD_URI_SAFE_ATTR" in e ? E(L(Be), e.ADD_URI_SAFE_ATTR) : Be),
              (Pe =
                "ADD_DATA_URI_TAGS" in e ? E(L(qe), e.ADD_DATA_URI_TAGS) : qe),
              ...
              (_e = e.RETURN_DOM_IMPORT || !1),
              (Ce = e.RETURN_TRUSTED_TYPE || !1),
              (Ne = e.FORCE_BODY || !1),
              (je = !1 !== e.SANITIZE_DOM),
              (He = !1 !== e.KEEP_CONTENT),
              (Fe = e.IN_PLACE || !1),
              (ye = e.ALLOWED_URI_REGEXP || ye),
              ke && (Se = !1),
              De && (Me = !0),
              Ue &&
                ((ve = E({}, [].concat(W(M)))),
                (be = []),
                !0 === Ue.html && (E(ve, k), E(be, D)),
                !0 === Ue.svg && (E(ve, R), E(be, _), E(be, j)),
                !0 === Ue.svgFilters && (E(ve, O), E(be, _), E(be, j)),
                !0 === Ue.mathMl && (E(ve, N), E(be, C), E(be, j))),
              e.ADD_TAGS && (ve === ge && (ve = L(ve)), E(ve, e.ADD_TAGS)),
              e.ADD_ATTR && (be === Te && (be = L(be)), E(be, e.ADD_ATTR)),
              e.ADD_URI_SAFE_ATTR && E(ze, e.ADD_URI_SAFE_ATTR),
              He && (ve["#text"] = !0),
              Re && E(ve, ["html", "head", "body"]),
              ve.table && (E(ve, ["tbody"]), delete Ae.tbody),
              o && o(e),
              (We = e));
          },
          Xe = function (e) {
        ...
        var Je = function (e) {
          ...
          et = function (e) {
            var t = void 0;
            if ((Ze("beforeSanitizeElements", e, null), Ye(e)))
              return Xe(e), !0;
            var n = m(e.nodeName);
            if (
              (Ze("uponSanitizeElement", e, { tagName: n, allowedTags: ve }),
              ("svg" === n || "math" === n) &&
                0 !== e.querySelectorAll("p, br").length)
            )
              return Xe(e), !0;
            if (!ve[n] || Ae[n]) {
              if (He && !Ie[n] && "function" == typeof e.insertAdjacentHTML)
                try {
                  var o = e.innerHTML;
            ...
            return ("noscript" === n && T(/<\/noscript/i, e.innerHTML)) ||
              ("noembed" === n && T(/<\/noembed/i, e.innerHTML))
              ? (Xe(e), !0)
              : (!Le ||
                  e.firstElementChild ||
          ...
          tt = function (e, t, r) {
            if (je && ("id" === t || "name" === t) && (r in s || r in Ge))
              return !1;
            if (Se && T(de, t));
            else if (we && T(pe, t));
            else {
                ...
                if (
                  ...
                  if ("name" === i && "IMG" === e.nodeName && c.id)
                    ...
                    if (
                      ...
                      continue;
                    "id" === y && e.setAttribute(y, ""), Ke(y, e);
                  }
                  if (u.keepAttr)
                    if (Le && T(/\/>/i, o)) Ke(y, e);
                    else if (
                      T(/svg|math/i, e.namespaceURI) &&
                      T(A("</(" + f(n(Ie), "|") + ")", "i"), o)
                    )
                      Ke(y, e);
                    else {
                      ke && ((o = v(o, le, " ")), (o = v(o, fe, " ")));
                      var x = e.nodeName.toLowerCase();
                      if (tt(x, i, o))
                        try {
                          g ? e.setAttributeNS(g, y, o) : e.setAttribute(y, o),
                            d(r.removed);
                        } catch (e) {}
                    }
                }
          ...
          nt = function e(t) {
            ...
            for (Ze("beforeSanitizeShadowDOM", t, null); (r = n.nextNode()); )
              Ze("uponSanitizeShadowNode", r, null),
                et(r) || (r.content instanceof c && e(r.content), rt(r));
        ...
        return (
          (r.sanitize = function (e, n) {
            ...
            if (
              ...
              if (!Me && !ke && !Re && -1 === e.indexOf("<"))
                return te && Ce ? te.createHTML(e) : e;
              if (!(o = $e(e))) return Me ? null : re;
            }
            o && Ne && Xe(o.firstChild);
            for (var f = Je(Fe ? e : o); (s = f.nextNode()); )
              (3 === s.nodeType && s === u) ||
                et(s) ||
                (s.content instanceof c && nt(s.content), rt(s), (u = s));
            ...
            if (Me) {
              ...
              return _e && (l = ce.call(i, l, !0)), l;
            }
            var d = Re ? o.outerHTML : o.innerHTML;
            return (
              ke && ((d = v(d, le, " ")), (d = v(d, fe, " "))),
              te && Ce ? te.createHTML(d) : d
            );
          }),
          ...
          (r.addHook = function (e, t) {
            "function" == typeof t && ((ue[e] = ue[e] || []), p(ue[e], t));
          }),
            ...
            value: function (e) {
              e.length
                ...
                : (this.resultsArea.innerHTML =
                    '<p class="alert alert-danger text-center shadow-sm">Sorry, we could not find results for that search.</p>'),
                this.hideLoderIcon(),
